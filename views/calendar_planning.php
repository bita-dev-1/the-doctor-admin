                                ...
                                <form class="event-form needs-validation" data-id="0" novalidate>
                                    <div class="mb-1">
                                        ...
                                        <input type="text" class="form-control" id="title" name="title"
                                            placeholder="Nom du Patient" readonly />
                                    </div>
                                    <div class="mb-1">

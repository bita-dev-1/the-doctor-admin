...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= SITE_URL; ?>/app-assets/vendors/css/tables/datatable/dataTables.bootstrap5.min.css">
    <link rel="stylesheet" type="text/css" href="<?= SITE_URL; ?>/app-assets/vendors/css/tables/datatable/responsive.bootstrap5.min.css">
    <link rel="stylesheet" type="text/css" href="<?= SITE_URL; ?>/app-assets/vendors/css/tables/datatable/buttons.bootstrap5.min.css">
    <link rel="stylesheet" type="text/css" href="<?= SITE_URL; ?>/app-assets/vendors/css/tables/datatable/rowGroup.bootstrap5.min.css">
    <link rel="stylesheet" type="text/css" href="<?= SITE_URL; ?>/app-assets/vendors/css/pickers/flatpickr/flatpickr.min.css">
    <!-- <link rel="stylesheet" type="text/css" href="<?= SITE_URL; ?>/app-assets/vendors/css/editors/quill/katex.min.css">
    <link rel="stylesheet" type="text/css" href="<?= SITE_URL; ?>/app-assets/vendors/css/editors/quill/monokai-sublime.min.css">
    <link rel="stylesheet" type="text/css" href="<?= SITE_URL; ?>/app-assets/vendors/css/editors/quill/quill.snow.css">
    <link rel="stylesheet" type="text/css" href="<?= SITE_URL; ?>/app-assets/vendors/css/editors/quill/quill.bubble.css"> -->
    <!-- END: Vendor CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="<?= SITE_URL; ?>/app-assets/css<?= $rtl; ?>/plugins/forms/pickers/form-flat-pickr.css">
    <link rel="stylesheet" type="text/css" href="<?= SITE_URL; ?>/app-assets/css<?= $rtl; ?>/plugins/forms/form-validation.css">
    <link rel="stylesheet" type="text/css" href="<?= SITE_URL; ?>/app-assets/css<?= $rtl; ?>/core/menu/menu-types/vertical-menu.css">
    <link rel="stylesheet" type="text/css" href="<?= SITE_URL; ?>/app-assets/css<?= $rtl; ?>/plugins/extensions/ext-component-swiper.css">
    ...
    <link rel="stylesheet" type="text/css" href="<?= SITE_URL; ?>/app-assets/css<?= $rtl; ?>/pages/app-chat-list.css">
       <!--  END: Page CSS-->
<!-- 
    <link rel="stylesheet" type="text/css" href="<?= SITE_URL; ?>/app-assets/css<?= $rtl; ?>/plugins/forms/form-quill-editor.css">
    <link rel="stylesheet" type="text/css" href="<?= SITE_URL; ?>/app-assets/css<?= $rtl; ?>/pages/page-blog.css">
